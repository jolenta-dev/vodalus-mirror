...
function addLine(id, text, useHtml) {
  var st = ensureState(id);
  st.lines.push({ text, useHtml: !!useHtml });
    ...
    if (fin.phrase && cfg.phraseParts) {
      ...
      fetch("/api/phrases", {
        ...
        if (result.ok && result.data.success) {
          ...
          addLine(id, err ? "Could not save your phrase: " + err + " Contact Jolenta if this persists." : "An error occurred while entering your phrase into the database. Please note this error and contact Jolenta for help.", false);
        }
      }).catch(function() {
